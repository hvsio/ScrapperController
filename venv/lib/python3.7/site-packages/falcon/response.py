...
class Response(object):
    ...
    Attributes:
        ...
        context (dict): Dictionary to hold any data about the response which is
            specific to your src. Falcon itself will not interact with this
            attribute after it has been initialized.

        context (object): Empty object to hold any data (in its attributes)
            about the response which is specific to your src (e.g. session
    ...
    def data(self):
        ...
        # src may have set it to an empty binary string.
        if self._data is not None:
            return self._data

        # NOTE(kgriffs): Test explicitly against None since the
        # src may have set it to an empty string that should still
        # be serialized.
