...
class Request(object):
    ...
    Attributes:
        ...
        context (object): Empty object to hold any data (in its attributes)
            about the request which is specific to your src (e.g. session
        ...
        src (str): The initial portion of the request URI's path that
        ...
        path (str): Path portion of the request URI (not including query
            ...
            Note:
                ...
                be used by the src for any upstream requests, any non URL-safe
        ...
        uri_template (str): The template for the route that was matched for
            ...
            methods. May also be ``None`` if your src uses a custom routing
        ...
        stream: File-like input object for reading the body of the
            ...
            differently depending on how you host your src. For example,
    ...
    def if_match(self):
        ...
        #   present in the request. The reason is that if the src
