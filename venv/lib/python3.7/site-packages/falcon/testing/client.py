...
def simulate_get(app, path, **kwargs):
    ...
    Equivalent to::
         ...
         simulate_request(src, 'GET', path, **kwargs)
...
def simulate_head(app, path, **kwargs):
    ...
    Equivalent to::
         ...
         simulate_request(src, 'HEAD', path, **kwargs)
...
def simulate_post(app, path, **kwargs):
    ...
    Equivalent to::
         ...
         simulate_request(src, 'POST', path, **kwargs)
...
def simulate_put(app, path, **kwargs):
    ...
    Equivalent to::
         ...
         simulate_request(src, 'PUT', path, **kwargs)
...
def simulate_options(app, path, **kwargs):
    ...
    Equivalent to::
         ...
         simulate_request(src, 'OPTIONS', path, **kwargs)
...
def simulate_patch(app, path, **kwargs):
    ...
    Equivalent to::
         ...
         simulate_request(src, 'PATCH', path, **kwargs)
...
def simulate_delete(app, path, **kwargs):
    ...
    Equivalent to::
         ...
         simulate_request(src, 'DELETE', path, **kwargs)
...
class TestClient(object):
    ...
    test functions. It lets you replace this::
        ...
        simulate_get(src, '/messages')
        simulate_head(src, '/messages')
    ...
    def simulate_request(self, *args, **kwargs):
        ...
        WSGI request directly against ``self.src``. Equivalent to::

            falcon.testing.simulate_request(self.src, *args, **kwargs)
        """
