...
"""Watch changes on a collection, a services, or the entire cluster."""
...
class ChangeStream(object):
    ...
    :meth:`pymongo.services.Database.watch`, or
...
class DatabaseChangeStream(ChangeStream):
    """A change stream that watches changes on all collections in a services.

    Should not be called directly by application developers. Use
    helper method :meth:`pymongo.services.Database.watch` instead.
