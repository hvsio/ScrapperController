...
class _OpReply(object):
    ...
    def raw_response(self, cursor_id=None):
        """Check the response header from the services, without decoding BSON.
        ...
        if self.flags & 1:
            ...
            if error_object["$err"].startswith("not master"):
                ...
                raise ExecutionTimeout(error_object.get("$err"),
                                       ...
                                       error_object)
            raise OperationFailure("services error: %s" %
    ...
    def unpack_response(self, cursor_id=None,
        ...
        """Unpack a response from the services and decode the BSON document(s).
