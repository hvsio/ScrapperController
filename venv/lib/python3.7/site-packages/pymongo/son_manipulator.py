...
class SONManipulator(object):
    ...
    def transform_incoming(self, son, collection):
        ...
        :Parameters:
          - `son`: the SON object to be inserted into the services
    ...
    def transform_outgoing(self, son, collection):
        ...
        :Parameters:
          - `son`: the SON object being retrieved from the services
...
class AutoReference(SONManipulator):
    ...
    TODO: this only works for documents that are in the same services. To fix
    this we'll need to add a DatabaseInjector that adds *_db* and then make
    use of the optional *services* support for DBRefs.
    """
