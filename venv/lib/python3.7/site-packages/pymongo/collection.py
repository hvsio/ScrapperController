...
class Collection(common.BaseObject):
    ...
    def __init__(self, database, name, create=False, codec_options=None,
        ...
        :meth:`~pymongo.services.Database.create_collection` for valid
        options.
        ...
        :Parameters:
          - `services`: the services to get a collection from
          - `name`: the name of the collection to get
          - `create` (optional): if ``True``, force collection
            creation even without options being set
          - `codec_options` (optional): An instance of
            :class:`~bson.codec_options.CodecOptions`. If ``None`` (the
            default) services.codec_options is used.
          - `read_preference` (optional): The read preference to use. If
            ``None`` (the default) services.read_preference is used.
          - `write_concern` (optional): An instance of
            :class:`~pymongo.write_concern.WriteConcern`. If ``None`` (the
            default) services.write_concern is used.
          - `read_concern` (optional): An instance of
            :class:`~pymongo.read_concern.ReadConcern`. If ``None`` (the
            default) services.read_concern is used.
    ...
    @property
    def database(self):
        """The :class:`~pymongo.services.Database` that this
    ...
    def drop(self, session=None):
        """Alias for :meth:`~pymongo.services.Database.drop_collection`.
    ...
    def find_one(self, filter=None, *args, **kwargs):
        """Get a single document from the services.
    ...
    def find_raw_batches(self, *args, **kwargs):
        """Query the services and retrieve batches of raw BSON.
    ...
    def options(self, session=None):
        ...
        :meth:`~pymongo.services.Database.create_collection` for more
    ...
    def aggregate(self, pipeline, session=None, **kwargs):
        ...
        .. note:: This method does not support the 'explain' option. Please
           use :meth:`~pymongo.services.Database.command` instead. An
    ...
    def map_reduce(self, map, reduce, out, full_response=False, session=None,
        ...
        :Parameters:
          ...
          - `out`: output collection name or `out object` (dict). See
            ...
            e.g. SON([('replace', <collection name>), ('db', <services name>)])
