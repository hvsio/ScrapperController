...
def _check_name(name):
    """Check if a services name is valid.
    """
    if not name:
        raise InvalidName("services name cannot be the empty string")

    for invalid_char in [' ', '.', '$', '/', '\\', '\x00', '"']:
        if invalid_char in name:
            raise InvalidName("services names cannot contain the "
...
class Database(common.BaseObject):
    ...
    def __init__(self, client, name, codec_options=None, read_preference=None,
        ...
        """Get a services by client and name.
        ...
        .. versionchanged:: 3.0
           ...
           :class:`~pymongo.services.Database` no longer returns an instance
    ...
    def add_son_manipulator(self, manipulator):
        """Add a new son manipulator to this services.
    ...
    def with_options(self, codec_options=None, read_preference=None,
                     write_concern=None, read_concern=None):
        """Get a clone of this services changing the specified settings.
    ...
    def __getattr__(self, name):
        """Get a collection of this services by name.
        ...
        if name.startswith('_'):
            raise AttributeError(
                ...
                " collection, use services[%r]." % (name, name, name))
    ...
    def _fix_incoming(self, son, collection):
        ...
        :Parameters:
          - `son`: the son object going into the services
    ...
    def _fix_outgoing(self, son, collection):
        """Apply manipulators to a SON object as it comes out of the services.

        :Parameters:
          - `son`: the son object coming out of the services
    ...
    def aggregate(self, pipeline, session=None, **kwargs):
        """Perform a services-level aggregation.
        ...
        .. note:: This method does not support the 'explain' option. Please
           use :meth:`~pymongo.services.Database.command` instead.

        .. note:: The :attr:`~pymongo.services.Database.write_concern` of
    ...
    def watch(self, pipeline=None, full_document=None, resume_after=None,
        ...
        """Watch changes on this services.

        Performs an aggregation with an implicit initial ``$changeStream``
        stage and returns a
        :class:`~pymongo.change_stream.DatabaseChangeStream` cursor which
        iterates over changes on all collections in this services.
    ...
    def command(self, command, value=1, check=True,
        ...
        Send command `command` to the services and return the
    ...
    def list_collections(self, session=None, filter=None, **kwargs):
        """Get a cursor over the collectons of this services.
    ...
    def list_collection_names(self, session=None, filter=None, **kwargs):
        """Get a list of all the collection names in this services.
    ...
    def drop_collection(self, name_or_collection, session=None):
        ...
        .. note:: The :attr:`~pymongo.services.Database.write_concern` of
           this services is automatically applied to this operation when using
           MongoDB >= 3.4.
        ...
        .. versionchanged:: 3.4
           Apply this services's write concern automatically to this operation
    ...
    def profiling_level(self, session=None):
        """Get the services's current profiling level.
    ...
    def set_profiling_level(self, level, slow_ms=None, session=None):
        """Set the services's profiling level.
    ...
    def previous_error(self):
        """**DEPRECATED**: Get the most recent error on this services.
    ...
    def reset_error_history(self):
        """**DEPRECATED**: Reset the error history of this services.
    ...
    def _default_role(self, read_only):
        """Return the default user role for this services."""
        if self.name == "admin":
            if read_only:
    ...
    def add_user(self, name, password=None, read_only=None, session=None,
        ...
        .. note:: add_user is deprecated and will be removed in PyMongo
          ...
          services commands, createUser_, usersInfo_, updateUser_, and
          dropUser_.
    ...
    def authenticate(self, name=None, password=None,
        ...
        """**DEPRECATED**: Authenticate to use this services.
        ...
        .. note::
          ...
          - Authenticating more than once on the same services with different
        ...
        :Parameters:
          ...
          - `source` (optional): the services to authenticate on. If not
            specified the current services is used.
    ...
    def logout(self):
        """**DEPRECATED**: Deauthorize use of this services.
    ...
    def dereference(self, dbref, session=None, **kwargs):
        ...
        :class:`ValueError` if `dbref` has a services specified that
        is different from the current services.
        ...
        if dbref.database is not None and dbref.database != self.__name:
            raise ValueError("trying to dereference a DBRef that points to "
                             "another services (%r not %r)" % (dbref.database,
                                                               self.__name))
...
class SystemJS(object):
    ...
    def __init__(self, database):
        """**DEPRECATED**: Get a system js helper for the services `services`.
    ...
    def list(self):
        """Get a list of the names of the functions stored in this services."""
