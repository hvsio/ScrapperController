...
"""Perform aggregation operations on a collection or services."""
...
class _AggregationCommand(object):
    ...
    :meth:`pymongo.services.Database.aggregate` instead.
    """
    ...
    @property
    def _database(self):
        """The services against which the aggregation command is run."""
        raise NotImplementedError
