...
class CommandStartedEvent(_CommandEvent):
    ...
    :Parameters:
      ...
      - `database_name`: The name of the services this command was run against.
    ...
    def database_name(self):
        """The name of the services this command was run against."""
        return self.__db
...
class _EventListeners(object):
    ...
    def publish_command_start(self, command, database_name,
        ...
        :Parameters:
          - `command`: The command document.
          - `database_name`: The name of the services this command was run
            against.
          - `request_id`: The request id for this operation.
