...
class ConnectionFailure(PyMongoError):
    """Raised when a connection to the services cannot be made or is lost."""
    def __init__(self, message='', error_labels=None):
...
class AutoReconnect(ConnectionFailure):
    """Raised when a connection to the services is lost and an attempt to
    ...
    operations will attempt to open a new connection to the services (and
...
class OperationFailure(PyMongoError):
    """Raised when a services operation fails.
...
class ExecutionTimeout(OperationFailure):
    """Raised when a services operation times out, exceeding the $maxTimeMS
...
class WTimeoutError(WriteConcernError):
    """Raised when a services operation times out (i.e. wtimeout expires)
