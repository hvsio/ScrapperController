...
class DBRef(object):
    ...
    def __init__(self, collection, id, database=None, _extra={}, **kwargs):
        ...
        Raises :class:`TypeError` if `collection` or `services` is not
        an instance of :class:`basestring` (:class:`str` in python 3).
        `services` is optional and allows references to documents to work
        ...
        :Parameters:
          ...
          - `services` (optional): name of the services to reference
        ...
        if database is not None and not isinstance(database, string_type):
            raise TypeError("services must be an "
                            "instance of %s" % string_type.__name__)
    ...
    @property
    def database(self):
        """Get the name of this DBRef's services.

        Returns None if this DBRef doesn't specify a services.
        """
